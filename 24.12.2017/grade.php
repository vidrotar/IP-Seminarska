...
<body">
	...
	<div id="page-wrap">
      ...
      <?php 
        // izpis odgovorov
        // echo "Vprsalnik: " . $_GET["vprasalnik"];
        ...
        if($_POST["vprasalnik"] == "MFIS"){
            ...
            foreach ($_POST as $key => $value) {
              pisiConsola( "--> emso:". $_POST["emso"] ." Vprasanje id: " . $key . " Odgovor: " . $value);
              $sql = "INSERT INTO odgovori (id_uporabnik,id_odgovor,datum)VALUES (". $_POST["emso"] .", ". $value. ",".$_POST["datum"]. ")";
              $rez = $conn->query($sql);
...
// INSERT INTO `odgovori` (`id_odgovori`, `id_uporabnik`, `id_odgovor`, `datum`) VALUES ('1', '1', '1', '2017-12-13 00:00:00');
